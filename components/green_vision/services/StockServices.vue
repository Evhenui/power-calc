      ...
      <div class="home-services__wrapper">
        <DescriptionSection class="home-services__description">
          <p class="home-services__description-text">
            Склад — это огромный сейф для всех товарных активов компании. Хищения, взломы,
            пожар и другие угрозы можно предотвратить при помощи современных систем видеонаблюдения 
            GreenVision 
          </p>
        </DescriptionSection>
          ...
          <template v-slot:card>
            ...
            <CardCapabilitiesColumn class="home-services__capabilities-card">
              <template v-slot:image>
                <img
                  src="@/assets/img/car-capabilities.svg"
                  alt="view teritory"
                />
              </template>
              <template v-slot:subtitle>Контроль перемещения сотрудников и груза на улице</template>
            </CardCapabilitiesColumn>
  
            <CardCapabilitiesColumn class="home-services__capabilities-card">
              <template v-slot:image>
                <img
                  src="@/assets/img/loading-capabilities.svg"
                  alt="view teritory"
                />
              </template>
            ...
            <CardCapabilitiesColumn class="home-services__capabilities-card">
              <template v-slot:image>
                <img
                  src="@/assets/img/control-capabilities.svg"
                  alt="view teritory"
                />
              </template>
              <template v-slot:subtitle>Контроль перемещения сотрудников и грузов по складу</template>
            </CardCapabilitiesColumn>
  
            <CardCapabilitiesColumn class="home-services__capabilities-card">
              <template v-slot:image>
                <img
                  src="@/assets/img/clock-capabilities.svg"
                  alt="view teritory"
                />
              </template>
              <template v-slot:subtitle>Контроль учета рабочего времени сотрудников</template>
            </CardCapabilitiesColumn>
          </template>
        </Capabilities>
        ...
        <DescriptionSection class="home-services__description">
          <p class="home-services__description-text">
            Широкий спектр профессионального оборудования для систем видеонаблюдения и 
            систем контроля доступа; разработка схем размещения оборудования с учетом 
            особенностей каждого объекта; гарантии и техническое обслуживание. 
          </p>
        </DescriptionSection>
  
        <BasicSet class="home-services__set">
          <template v-slot:title>Пример базового комплекта оборудования для системы видеонаблюдения на складе</template>
          ...
          <template v-slot:description>
            <p class="home-services__description-text slim">
              Базовый перечень оборудования решает основные проблемы видеоконтроля в квартире. 
        ...
        <LocationLong class="home-services__location">
          <template v-slot:cards>
            <CardLocation class="home-services__location-card">
              <template v-slot:image>
                <img
                  src="@/assets/icons/product-warehouse-location.svg"
                  alt="home teritory"
                />
              </template>
            ...
            <CardLocation class="home-services__location-card">
              <template v-slot:image>
                <img src="@/assets/icons/ramp-location.svg" alt="garage" />
              </template>
            ...
            <CardLocation class="home-services__location-card">
              <template v-slot:image>
                <img src="@/assets/icons/unloading-location.svg" alt="garage" />
              </template>
            ...
            <CardLocation class="home-services__location-card">
              <template v-slot:image>
                <img src="@/assets/icons/product-stock-location.svg" alt="garage" />
              </template>
            ...
            <CardLocation class="home-services__location-card">
              <template v-slot:image>
                <img src="@/assets/icons/perimeter-ware-location.svg" alt="garage" />
              </template>
          ...
          <template v-slot:subtitle>
            ...
            схему расположения камер исходя из конкретных целей и задач, которые должно 
            решить видеонаблюдение в Вашей торговой точке. Мы поставляем качественное 
            оборудование различных ценовых категорий (эконом, стандарт, премиум).
          </template>
        </LocationLong>
  
        <ServicePrice class="home-services__service-price">
          <template v-slot:title>Что входит в услугу установки типового комплекта видеонаблюдения на складе?</template>
          <template v-slot:price>80 000 ГРН</template>
          <template v-slot:item>
            <CheckItem class="home-services__price-item">
                Комплект видеонаблюдения FullHD разрешения, камеры для наружной 
                и внутренней установки с инфракрасной подсветкой до 20 метров 
            </CheckItem>
            <CheckItem class="home-services__price-item">
          ...
          <template v-slot:item>
            <div class="home-services__offer-section">
              ...
              <CheckItem class="home-services__offer-item">
                ...
                (крепление стяжки; клипсы; под армрстронгом, без сверления отверстий 
                для фиксации кабельной трассы) на высоте до 3 метров
              </CheckItem>
              <CheckItem class="home-services__offer-item">
                Сверление не более 16 отверстий до 20 сантиметров для прокладки в них 
                кабеля по необходимости
              </CheckItem>
            </div>
            <div class="home-services__offer-section">
              <CheckItem class="home-services__offer-item">
                Подключение видеорегистратора и камер к сети (3 свободные розетки, или 
                удлинитель заказчика)
              </CheckItem>
              <CheckItem class="home-services__offer-item">
          ...
          <template v-slot:item>
            <div class="home-services__offer-section">
                ...
                <CheckItem class="home-services__offer-item">
                    ...
                    (обучение пользователя, просмотр записей, сохранение записи на usb или память телефона)
                </CheckItem>
            </div>
            <div class="home-services__offer-section">
                <CheckItem class="home-services__offer-item">
                ...
                <CheckItem class="home-services__offer-item">
                    Консультация заказчика по установке соответствующей скорости интернета и статического адреса 
