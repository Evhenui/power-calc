<template>
  <section 
    class="rating" 
    :class="[{active: state}, {inactive: inactive}]"
  >
    ...
    <section class="rating__reviews">
      <a href="#" class="rating__review">125 отзывов</a>
    </section>
  </section>
</template>
