<template>
    <section class="pricess">
        <h1 class="pricess__title">Стоимость установки систем видеонаблюдения</h1>
...
export default class PricessComponent extends Vue {
    @Prop({required: false}) priceValues: any;
}
</script>
